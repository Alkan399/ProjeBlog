...
document.getElementById("filterButton").addEventListener("click", function () {
    const filters = {
        contentID: document.getElementById("filterId").value || null,
        ContentSetID: document.getElementById("filterName").value || null,
        order: document.getElementById("filterDescription").value || null,
        status: document.getElementById("filterStatus").value || null

    };
    const page = parseInt(pageToGo);
    const url = `/Management/ContentSetContent/FilterContents?page=${encodeURIComponent(page)}`;
